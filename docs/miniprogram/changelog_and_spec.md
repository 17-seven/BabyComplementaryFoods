...
| `pages/family/index.js` | **数据映射与退组改造（2026-07-01）**：<br>1. 改以云端 `members` 数组为循环基准，智能适配 `members_info`，修复创建者缺席的问题。<br>2. 改造 `leaveFamily` 接入 `removeMember` 云端解绑动作，彻底解决解绑退组残留问题。 |
