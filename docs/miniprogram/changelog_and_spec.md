...
| 2 | `pages/dashboard/index` | **首页概览**：宝宝名片、月龄展示、疫苗/儿保/就诊提醒、今日护理打卡汇总 |
...
| 6 | `pages/vision/index` | **视力遮盖计时**：眼罩佩戴计时器、每日4小时目标进度环 |
| 7 | `pages/bowel/index` | **排便记录**：便便颜色/性状/有无出血记录、历史日志 |
| 8 | `pages/nutrition/index` | **饮奶饮水记录**：每日奶量/水量打卡、进度统计 |
| 9 | `pages/allergen/index` | **排敏食材管理**：已排敏/未排敏食材池、食材详情与打卡观察、自定义新增 |
| 10 | `pages/my/index` | **我的**：登录状态、宝宝档案快捷入口、数据导入（开发者模式）、版本信息 |
| 11 | `pages/album/index` | **宝宝相册**：最多10张照片上传（云存储）、设为宝宝头像 |
| 12 | `pages/family/index` | **家庭协同**：创建家庭组、生成邀请码、爱人加入共享数据 |
| 13 | `pages/baby/index` | **宝宝档案**：姓名、出生日期、早产纠正天数自动计算 |
